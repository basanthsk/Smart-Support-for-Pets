        ...
        <div className="mt-6 flex flex-col gap-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button 
              ...
              disabled={isLoading} 
              className="flex items-center justify-center gap-2.5 bg-white border border-slate-200 py-3 rounded-xl font-bold text-slate-700 hover:bg-slate-50 transition-all active:scale-[0.98] disabled:opacity-50 text-xs shadow-sm"
            >
            ...
            <button 
              ...
              disabled={isLoading} 
              className="flex items-center justify-center gap-2.5 bg-black text-white py-3 rounded-xl font-bold hover:bg-zinc-900 transition-all active:scale-[0.98] disabled:opacity-50 text-xs shadow-sm"
            >
